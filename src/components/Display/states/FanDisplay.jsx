  ...
  return (
    <div className="flex flex-col justify-center h-full p-5 px-6">
      ...
      <div className="mx-auto flex items-start justify-center flex-1">
        {on
          ? <span className="font-sans text-[16px] font-light text-white/90 tracking-tight drop-shadow-[0_0_24px_rgba(232,200,122,0.45)]">{speed}</span>
          : <span className="text-[14px] font-light mt-1 text-white opacity-20">OFF</span>
        }
      </div>
