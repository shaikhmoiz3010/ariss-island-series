...
export default function LeftDisplay({ displayState, devices }) {
  ...
  return (
    <div className="" style={{ flex: 1, height: "100%", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      {displayState === "dim-toggle" && <DimmerDisplay device={lights} mode="toggle" />}
      {displayState === "dim" && <DimmerDisplay device={lights} mode="auto" />}
      {displayState === "bright" && <DimmerDisplay device={lights} mode="auto" />}
